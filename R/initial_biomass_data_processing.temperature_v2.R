...
for (i in 1:(length(unique(harvest.data$Room)))) {
  cat("Room # ", i, ": log(Stemmass) = ", coefficients(fit.sm[[i]])[1], "+", 
...
cat("\n"); cat("\n"); cat("Individual linear regression models:"); cat("\n")
for (i in 1:(length(unique(harvest.data$Room)))) {
  cat("Room # ", i, ": log(Rootmass) = ", coefficients(fit.rm[[i]])[1], "+", 
...
cat("\n"); cat("\n"); cat("Individual linear regression models:"); cat("\n")
for (i in 1:(length(unique(harvest.data$Room)))) {
  cat("Room # ", i, ": log(Leafmass) = ", coefficients(fit.lm[[i]])[1], "+", 
...
cat("\n"); cat("\n"); cat("Individual linear regression models:"); cat("\n")
for (i in 1:(length(unique(harvest.data$Room)))) {
  cat("Room # ", i, ": log(Leafarea) = ", coefficients(fit.la[[i]])[1], "+", 
